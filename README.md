...
A fuzz testing too for java applications using coverage to guide the process. Heavily based on the wonderful 
GoFuzz and AFL.

Uses Jacoco to get coverage stats. Has a maven plug for running.

## Usage

### Maven
* Include tribble-core as a dependency. You'll need to run `mvn install` from this project at the moment until I get time
to put this into maven central.
```
<dependency>
...
coverage stats for a run. This lets us work out the paths through the application we have found. 
